...
from apps.tickets.views_public import ticket_novo_view, ticket_success_view, ticket_upload_view, termos_view
...
urlpatterns = [
    ...
    path('termos/', termos_view, name='termos'),  # Termos de consentimento
